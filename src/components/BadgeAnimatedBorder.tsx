...
interface BadgeAnimatedBorderProps extends HTMLAttributes<HTMLDivElement> {
  children: React.ReactNode;
}

export const BadgeAnimatedBorder: React.FC<BadgeAnimatedBorderProps> = ({
  children,
  ...restProps
}) => {
  return (
    <div
      {...restProps}
      className="group relative grid overflow-hidden rounded-full px-3 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200"
    >
      <span>
